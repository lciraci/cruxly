    ...
    <div className="space-y-4">
      <div className="bg-white/[0.03] rounded-xl border border-white/[0.07] p-5 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          <div>
            <h2 className="text-lg font-bold text-zinc-100 mb-1">Story DNA</h2>
        ...
        {/* Always-visible section legend */}
        <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-xs text-zinc-600 border-t border-white/[0.05] pt-4">
          <span className="font-semibold text-zinc-500 uppercase tracking-widest text-[10px] self-center mr-1">Legend:</span>
          <span className="flex items-center gap-1.5"><span className="font-bold text-emerald-400">+</span> New consensus — claims now agreed by multiple sources</span>
          <span className="flex items-center gap-1.5"><span className="font-bold text-rose-400">−</span> Dropped — facts sources quietly stopped reporting</span>
          <span className="flex items-center gap-1.5"><span className="font-bold text-amber-400">!</span> Newly disputed — claims now being questioned</span>
          <span className="flex items-center gap-1.5"><span className="font-bold text-blue-400">✓</span> Resolved — disputes sources now agree on</span>
        </div>
                ...
                >
                  {analyzing ? (
                    ...
                    <>
                      ...
                      {!user ? 'Get the Crux — free' : 'Get the Crux'}
                    </>
                  )}
                </button>
